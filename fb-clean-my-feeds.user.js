      ...
      module.exports = {
        translations: {
          ...
          cs: {
            ...
            NF_AI_INFO_POSTS: "P\u0159\xEDsp\u011Bvky ozna\u010Den\xE9 \u201EAI info\u201C",
            ...
            DLG_TIPS_CREDITS: "Speci\xE1ln\xED pod\u011Bkov\xE1n\xED {zbluebugz} za p\u016Fvodn\xED projekt a {trinhquocviet} za pomoc s \xFAdr\u017Ebou filtr\u016F v roce 2025.",
          ...
          de: {
            ...
            NF_AI_INFO_POSTS: "Beitr\xE4ge mit \u201EAI info\u201C-Kennzeichnung",
            ...
            DLG_TIPS_CREDITS: "Besonderer Dank an {zbluebugz} f\xFCr das urspr\xFCngliche Projekt und an {trinhquocviet} f\xFCr die Hilfe bei der Filterpflege im Jahr 2025.",
          ...
          // -- Suomi - Finnish (Finland)
            ...
            NF_AI_INFO_POSTS: 'Julkaisut, joissa on "AI info" -merkint\xE4',
            ...
            DLG_TIPS_CREDITS: "Erityiskiitos {zbluebugz}:lle alkuper\xE4isest\xE4 projektista ja {trinhquocviet}:lle avusta suodattimien yll\xE4pidossa vuonna 2025.",
          ...
          fr: {
            ...
            NF_AI_INFO_POSTS: 'Publications portant le libell\xE9 "AI info"',
            ...
            DLG_TIPS_CREDITS: "Remerciements particuliers \xE0 {zbluebugz} pour le projet original, et \xE0 {trinhquocviet} pour son aide dans la maintenance des filtres en 2025.",
          ...
          pl: {
            ...
            DLG_TIPS_CREDITS: "Specjalne podzi\u0119kowania dla {zbluebugz} za oryginalny projekt oraz dla {trinhquocviet} za pomoc w utrzymaniu filtr\xF3w w 2025 roku.",
          ...
          pt: {
            ...
            NF_AI_INFO_POSTS: 'Publica\xE7\xF5es marcadas como "AI info"',
            ...
            DLG_TIPS_CREDITS: "Agradecimento especial a {zbluebugz} pelo projeto original e a {trinhquocviet} pela ajuda na manuten\xE7\xE3o dos filtros em 2025.",
          ...
          tr: {
            ...
            NF_AI_INFO_POSTS: '"AI info" etiketi ta\u015F\u0131yan g\xF6nderiler',
            ...
            DLG_TIPS_CREDITS: "Orijinal proje i\xE7in {zbluebugz}'a ve 2025 y\u0131l\u0131nda filtre bak\u0131m\u0131na yard\u0131mc\u0131 oldu\u011Fu i\xE7in {trinhquocviet}'e \xF6zel te\u015Fekk\xFCrler.",
          ...
          vi: {
            ...
            NF_AI_INFO_POSTS: 'B\xE0i vi\u1EBFt c\xF3 nh\xE3n "AI info"',
            ...
            DLG_TIPS_CREDITS: "Xin c\u1EA3m \u01A1n \u0111\u1EB7c bi\u1EC7t t\u1EDBi {zbluebugz} cho d\u1EF1 \xE1n g\u1ED1c v\xE0 {trinhquocviet} v\xEC \u0111\xE3 gi\xFAp duy tr\xEC b\u1ED9 l\u1ECDc trong n\u0103m 2025.",
...
`;
  ...
  var require_dirty_check = __commonJS({
    "src/dom/dirty-check.js"(exports, module) {
      var { postAtt, postAttTab } = require_attributes();
      var dirtyTokens = /* @__PURE__ */ new WeakMap();
      var postSignatures = /* @__PURE__ */ new WeakMap();
      ...
      function isMarketplaceDirty(state) {
        if (state.mpType === "item") {
          ...
          if (mainColumn) {
            ...
            if (mainColumn2) {
              ensureDirtyObserver(mainColumn2);
              if (!mainColumn2.hasAttribute(mainColumnAtt)) {
                mainColumn2.setAttribute(mainColumnAtt, "1");
                markElementDirty(mainColumn2);
              }
              if (state && state.forceProcess) {
                markElementDirty(mainColumn2);
              }
  ...
  var require_news2 = __commonJS({
    "src/feeds/news.js"(exports, module) {
      ...
      var { isSponsored } = require_sponsored();
      var { hideNumberOfShares } = require_shares();
      var newsPostSweepIntervalMs = 750;
      var prioritizedNewsPostQueries = Array.from(
        /* @__PURE__ */ new Set([
          'div[role="main"] div[aria-posinset]',
          'div[role="main"] div[role="article"]',
      ...
      function isMetaAiPromptSuggestionRow(row) {
        ...
        const signals = getMetaAiPromptChipButtons(row).map((button) => getMetaAiSuggestionChipSignal(button)).filter(Boolean);
  ...
  // src/dom/topbar-controls.js
  var require_topbar_controls = __commonJS({
    "src/dom/topbar-controls.js"(exports, module) {
      var MIN_CONTROL_SIZE = 28;
      var MAX_CONTROL_SIZE = 72;
      var MIN_ASPECT_RATIO = 0.75;
      var MAX_ASPECT_RATIO = 1.35;
      var MAX_CLUSTER_GAP = 24;
      var MAX_ROW_OFFSET = 12;
      var RECT_MATCH_TOLERANCE = 1;
      var topbarControlSelector = 'button, [role="button"], a[aria-label]';
  ...
  var require_toggle_button = __commonJS({
    "src/ui/controls/toggle-button.js"(exports, module) {
      var { getTopbarMenuButton } = require_topbar_controls();
      var { attachTooltip } = require_tooltip();
      var pageDimmedAtt = "data-cmf-page-dimmed";
  ...
  var require_dialog = __commonJS({
    "src/ui/dialog/dialog.js"(exports, module) {
      ...
      var { getTopbarControlButtons, isTopbarControlButton } = require_topbar_controls();
      ...
      function initDialog(context, helpers) {
        ...
        const handlers = {
          saveUserOptions: async (event, source = "dialog") => {
            ...
            const previousBtnLocation = state.options && state.options.CMF_BTN_OPTION ? state.options.CMF_BTN_OPTION.toString() : defaults.CMF_BTN_OPTION;
            if (source === "dialog") {
            ...
            const nextBtnLocation = hydrated.options && hydrated.options.CMF_BTN_OPTION ? hydrated.options.CMF_BTN_OPTION.toString() : defaults.CMF_BTN_OPTION;
