  ...
  var require_topbar_controls = __commonJS({
    "src/dom/topbar-controls.js"(exports, module) {
      ...
      function getTopbarControlButtons(root = document) {
        ...
        const controls = Array.from(new Set(Array.from(banner.querySelectorAll('button, [role="button"]')))).filter((control) => isTopbarControlCandidate(control, bannerRect)).map((control) => ({
          element: control,
