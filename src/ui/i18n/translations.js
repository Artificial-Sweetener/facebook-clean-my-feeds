module.exports = {
  translations: {
    ...
    en: {
      ...
      DLG_TIPS_CONTENT:
        "Save keeps your preferences right here in your browser and applies them instantly. Export/Import lets you carry them to another device. Private/incognito or cleared site data resets them.",
      ...
      DLG_TIPS_THANKS: "If this helps, a star on GitHub means a lot. Thank you! 💖",
    ...
    ar: {
      ...
      DLG_TIPS_CONTENT:
        "يحفظ زر الحفظ تفضيلاتك في متصفحك ويطبقها فورًا. يتيح لك التصدير/الاستيراد نقلها إلى جهاز آخر. التصفح الخاص/الخفي أو مسح بيانات الموقع يعيد ضبطها.",
      ...
      DLG_TIPS_THANKS: "إن أفادك هذا، فنجمة على GitHub تعني الكثير. شكرًا لك! 💖",
    ...
    bg: {
      ...
      DLG_TIPS_CONTENT:
        "Save запазва предпочитанията ти в браузъра и ги прилага веднага. Export/Import ти позволява да ги прехвърлиш на друго устройство. Частният/инкогнито режим или изчистването на данните на сайта ги нулира.",
      ...
      DLG_TIPS_THANKS: "Ако това помага, една звезда в GitHub значи много. Благодаря! 💖",
    ...
    cs: {
      ...
      DLG_REPORT_BUG_NOTICE: "Texty příspěvků a jména jsou skryté. Před sdílením zkontroluj.",
      ...
      DLG_TIPS_DESC: "Odkazy na projekt, informace o správci a pomoc s nastavením.",
      DLG_TIPS_CONTENT:
        "Save ukládá vaše předvolby do prohlížeče a hned je použije. Export/Import vám umožní přenést je na jiné zařízení. Soukromé/inkognito nebo vymazání dat webu je resetuje.",
      ...
      DLG_TIPS_LINK_REPO: "Repozitář projektu",
      DLG_TIPS_LINK_FACEBOOK: "Pozdrav na Facebooku",
      DLG_TIPS_LINK_SITE: "Více ode mě",
      DLG_TIPS_THANKS: "Pokud to pomáhá, hvězda na GitHubu pro mě hodně znamená. Děkuji! 💖",
    ...
    de: {
      ...
      DLG_REPORT_BUG_NOTICE:
        "Beitragstexte und Namen werden ausgeblendet. Bitte vor dem Teilen prüfen.",
      ...
      DLG_TIPS_CONTENT:
        "Save speichert deine Einstellungen im Browser und wendet sie sofort an. Export/Import ermöglicht dir, sie auf ein anderes Gerät mitzunehmen. Privates/Inkognito‑Surfen oder gelöschte Websitedaten setzt sie zurück.",
      ...
      DLG_TIPS_THANKS: "Wenn dir das hilft, bedeutet ein Stern auf GitHub viel. Danke! 💖",
    ...
    el: {
      ...
      CMF_DIALOG_LANGUAGE_LABEL:
        "Καθαρίστε τη γλώσσα του παραθύρου διαλόγου με τα τροφοδοτούμενα μου",
      ...
      DLG_TIPS_CONTENT:
        "Το Save αποθηκεύει τις προτιμήσεις σου στον browser και τις εφαρμόζει αμέσως. Το Export/Import σου επιτρέπει να τις μεταφέρεις σε άλλη συσκευή. Η ιδιωτική/ανώνυμη περιήγηση ή η διαγραφή δεδομένων ιστότοπου τις επαναφέρει.",
      ...
      DLG_TIPS_THANKS: "Αν σε βοηθάει, ένα αστέρι στο GitHub σημαίνει πολλά. Ευχαριστώ! 💖",
    ...
    es: {
      ...
      DLG_TIPS_DESC: "Enlaces del proyecto, info del mantenedor y ayuda de configuración.",
      DLG_TIPS_CONTENT:
        "Save guarda tus preferencias en tu navegador y las aplica al instante. Export/Import te permite llevarlas a otro dispositivo. La navegación privada/incógnito o borrar los datos del sitio las restablece.",
      ...
      DLG_TIPS_LINK_FACEBOOK: "Salúdame en Facebook",
      DLG_TIPS_LINK_SITE: "Más de mí",
      DLG_TIPS_THANKS: "Si te ayuda, una estrella en GitHub significa mucho. ¡Gracias! 💖",
    ...
    // -- Suomi - Finnish (Finland)
      ...
      DLG_REPORT_BUG_NOTICE: "Julkaisujen teksti ja nimet peitetään. Tarkista ennen jakamista.",
      ...
      DLG_TIPS_DESC: "Projektin linkit, ylläpitäjän tiedot ja ohjeet.",
      DLG_TIPS_CONTENT:
        "Save tallentaa asetuksesi selaimeen ja ottaa ne käyttöön heti. Export/Import auttaa siirtämään ne toiselle laitteelle. Yksityinen/inkognito‑selailu tai sivustodatan tyhjennys nollaa ne.",
      ...
      DLG_TIPS_LINK_SITE: "Lisää minulta",
      DLG_TIPS_THANKS: "Jos tästä on apua, tähti GitHubissa merkitsee paljon. Kiitos! 💖",
    ...
    fr: {
      ...
      DLG_REPORT_BUG_NOTICE: "Les textes et noms sont masqués. Vérifiez avant de partager.",
      ...
      DLG_TIPS: "À propos / Conseils",
      DLG_TIPS_DESC: "Liens du projet, infos du mainteneur et aide à la configuration.",
      DLG_TIPS_CONTENT:
        "Save conserve vos préférences dans votre navigateur et les applique immédiatement. Export/Import permet de les emporter sur un autre appareil. La navigation privée/incognito ou l’effacement des données du site les réinitialise.",
      ...
      DLG_TIPS_THANKS: "Si cela vous aide, une étoile sur GitHub compte beaucoup. Merci ! 💖",
    ...
    he: {
      ...
      DLG_TIPS_CONTENT:
        "Save שומר את ההעדפות שלך בדפדפן ומחיל אותן מיד. Export/Import מאפשר להעביר אותן למכשיר אחר. גלישה פרטית/אינקוגניטו או מחיקת נתוני האתר יאפסו אותן.",
      ...
      DLG_TIPS_THANKS: "אם זה עוזר, כוכב ב‑GitHub שווה הרבה. תודה! 💖",
    ...
    id: {
      ...
      DLG_TIPS_CONTENT:
        "Save menyimpan preferensi Anda di browser dan menerapkannya langsung. Export/Import memungkinkan Anda membawanya ke perangkat lain. Mode privat/inkognito atau menghapus data situs akan meresetnya.",
      ...
      DLG_TIPS_THANKS: "Jika ini membantu, bintang di GitHub sangat berarti. Terima kasih! 💖",
    ...
    it: {
      ...
      DLG_TIPS_CONTENT:
        "Save salva le tue preferenze nel browser e le applica subito. Export/Import ti permette di portarle su un altro dispositivo. La navigazione privata/incognito o la pulizia dei dati del sito le reimposta.",
      ...
      DLG_TIPS_THANKS: "Se ti è utile, una stella su GitHub significa molto. Grazie! 💖",
    ...
    ja: {
      ...
      DLG_TIPS_CONTENT:
        "Save は設定をブラウザに保存してすぐ適用します。Export/Import で他のデバイスへ持ち運べます。プライベート/シークレットやサイトデータの削除でリセットされます。",
      ...
      DLG_TIPS_THANKS: "役に立ったら GitHub のスターが励みになります。ありがとうございます！💖",
    ...
    lv: {
      ...
      DLG_TIPS_CONTENT:
        "Save saglabā jūsu preferences pārlūkā un uzreiz tās piemēro. Export/Import ļauj tās pārnest uz citu ierīci. Privātā/inkognito pārlūkošana vai vietnes datu dzēšana tās atiestata.",
      ...
      DLG_TIPS_THANKS: "Ja tas palīdz, zvaigzne GitHubā man nozīmē daudz. Paldies! 💖",
    ...
    nl: {
      ...
      DLG_TIPS_CONTENT:
        "Save bewaart je voorkeuren in je browser en past ze meteen toe. Export/Import laat je ze meenemen naar een ander apparaat. Privé/incognito of het wissen van sitegegevens reset ze.",
      ...
      DLG_TIPS_THANKS: "Als dit helpt, betekent een ster op GitHub veel. Dank je! 💖",
    ...
    pl: {
      ...
      DLG_TIPS: "O projekcie / Wskazówki",
      DLG_TIPS_DESC: "Linki do projektu, informacje o opiekunie i pomoc w konfiguracji.",
      DLG_TIPS_CONTENT:
        "Save zapisuje preferencje w przeglądarce i od razu je stosuje. Export/Import pozwala przenieść je na inne urządzenie. Tryb prywatny/incognito lub wyczyszczenie danych witryny je zresetuje.",
      ...
      DLG_TIPS_THANKS: "Jeśli to pomaga, gwiazdka na GitHubie wiele dla mnie znaczy. Dziękuję! 💖",
    ...
    pt: {
      ...
      DLG_REPORT_BUG_NOTICE: "Textos e nomes são ocultados. Revise antes de compartilhar.",
      ...
      DLG_TIPS_DESC: "Links do projeto, info do mantenedor e ajuda de configuração.",
      DLG_TIPS_CONTENT:
        "Save guarda as suas preferências no navegador e aplica-as imediatamente. Export/Import permite levá-las para outro dispositivo. Navegação privada/incógnito ou apagar os dados do site reinicia-as.",
      ...
      DLG_TIPS_THANKS: "Se isso ajudar, uma estrela no GitHub significa muito. Obrigado! 💖",
    ...
    ru: {
      ...
      DLG_TIPS_CONTENT:
        "Save сохраняет ваши настройки в браузере и сразу применяет их. Export/Import позволяет перенести их на другое устройство. Приватный/инкогнито режим или очистка данных сайта сбросит их.",
      ...
      DLG_TIPS_THANKS: "Если это помогает, звезда на GitHub значит очень много. Спасибо! 💖",
    ...
    tr: {
      ...
      DLG_REPORT_BUG_NOTICE: "Gönderi metinleri ve adlar gizlenir. Paylaşmadan önce kontrol et.",
      ...
      DLG_TIPS: "Hakkında / İpuçları",
      DLG_TIPS_DESC: "Proje bağlantıları, bakım sorumlusu bilgisi ve kurulum yardımı.",
      DLG_TIPS_CONTENT:
        "Save, tercihlerinizi tarayıcınızda saklar ve hemen uygular. Export/Import onları başka bir cihaza taşımanıza yardımcı olur. Gizli/inkognito gezinti veya site verilerini temizlemek sıfırlar.",
      ...
      DLG_TIPS_THANKS: "Bu işe yararsa, GitHub’da bir yıldız çok şey ifade eder. Teşekkürler! 💖",
    ...
    uk: {
      ...
      DLG_TIPS_DESC:
        "Посилання на проєкт, інформація про супровідника та допомога з налаштуванням.",
      DLG_TIPS_CONTENT:
        "Save зберігає ваші налаштування в браузері та одразу їх застосовує. Export/Import дозволяє перенести їх на інший пристрій. Приватний/інкогніто режим або очищення даних сайту скидає їх.",
      ...
      DLG_TIPS_THANKS: "Якщо це допомагає, зірка на GitHub дуже багато для мене означає. Дякую! 💖",
    ...
    vi: {
      ...
      DLG_REPORT_BUG_NOTICE: "Nội dung và tên được ẩn. Kiểm tra trước khi chia sẻ.",
      ...
      DLG_TIPS_DESC: "Liên kết dự án, thông tin người bảo trì và trợ giúp thiết lập.",
      DLG_TIPS_CONTENT:
        "Save lưu các tuỳ chọn của bạn ngay trong trình duyệt và áp dụng ngay lập tức. Export/Import giúp bạn mang chúng sang thiết bị khác. Chế độ riêng tư/ẩn danh hoặc xoá dữ liệu trang web sẽ đặt lại chúng.",
      ...
      DLG_TIPS_LINK_REPO: "Repo dự án",
      DLG_TIPS_LINK_FACEBOOK: "Chào trên Facebook",
      DLG_TIPS_LINK_SITE: "Thêm từ mình",
      DLG_TIPS_THANKS: "Nếu thấy hữu ích, một ngôi sao trên GitHub có ý nghĩa rất lớn. Cảm ơn! 💖",
