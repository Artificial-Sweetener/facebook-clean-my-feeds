module.exports = {
    ...
    DLG_TIPS_CONTENT: 'Save ukládá vaše předvolby do prohlížeče a hned je použije. Export/Import vám umožní přenést je na jiné zařízení. Soukromé/inkognito nebo vymazání dat webu je resetuje.',
    ...
    DLG_REPORT_BUG_NOTICE: 'Beitragstexte und Namen werden ausgeblendet. Bitte vor dem Teilen prüfen.',
    ...
    DLG_TIPS_CONTENT: 'Save speichert deine Einstellungen im Browser und wendet sie sofort an. Export/Import ermöglicht dir, sie auf ein anderes Gerät mitzunehmen. Privates/Inkognito‑Surfen oder gelöschte Websitedaten setzt sie zurück.',
    ...
    DLG_TIPS_CONTENT: 'Save guarda tus preferencias en tu navegador y las aplica al instante. Export/Import te permite llevarlas a otro dispositivo. La navegación privada/incógnito o borrar los datos del sitio las restablece.',
    ...
    DLG_TIPS_CONTENT: 'Save tallentaa asetuksesi selaimeen ja ottaa ne käyttöön heti. Export/Import auttaa siirtämään ne toiselle laitteelle. Yksityinen/inkognito‑selailu tai sivustodatan tyhjennys nollaa ne.',
    ...
    DLG_TIPS_CONTENT: 'Save conserve vos préférences dans votre navigateur et les applique immédiatement. Export/Import permet de les emporter sur un autre appareil. La navigation privée/incognito ou l’effacement des données du site les réinitialise.',
    ...
    DLG_TIPS_CONTENT: 'Save bewaart je voorkeuren in je browser en past ze meteen toe. Export/Import laat je ze meenemen naar een ander apparaat. Privé/incognito of het wissen van sitegegevens reset ze.',
    ...
    DLG_TIPS_CONTENT: 'Save guarda as suas preferências no navegador e aplica-as imediatamente. Export/Import permite levá-las para outro dispositivo. Navegação privada/incógnito ou apagar os dados do site reinicia-as.',
    ...
    DLG_TIPS_CONTENT: 'Save lưu các tuỳ chọn của bạn ngay trong trình duyệt và áp dụng ngay lập tức. Export/Import giúp bạn mang chúng sang thiết bị khác. Chế độ riêng tư/ẩn danh hoặc xoá dữ liệu trang web sẽ đặt lại chúng.',
